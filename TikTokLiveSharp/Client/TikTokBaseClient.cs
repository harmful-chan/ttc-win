...
namespace TikTokLiveSharp.Client
{
    public abstract class TikTokBaseClient
    {
        ...
        public TikTokBaseClient(string uniqueID=null,
            ...
            string lang = "en-US")
        {
            ...
            this.http = new TikTokHTTPClient(timeout, proxyHandler , cookieContainer);
        ...
        public async Task<string> Run(CancellationToken? cancellationToken = null, bool retryConnection = false)
        {
            this.token = cancellationToken ?? new CancellationToken();
            token.ThrowIfCancellationRequested();
            string roomid = await this.Start(token, retryConnection);
